...
file_dir = 'C:/Users/bobna/Downloads/MLB_Stats/'
games = file_dir + '2020 MLB Schedule _ Baseball-Reference.com.html'
stats_template = file_dir + '2020 Major League Baseball Season Summary _ Baseball-Reference.com.html'
pitching_template = file_dir + '2020 Major League Baseball Standard Pitching _ Baseball-Reference.com.html'
daily_pitchers = file_dir + 'MLB Probable Pitchers _ Baseball-Reference.com.html'

#use box score link from each game in schedule file to obtain historical starting pitchers
